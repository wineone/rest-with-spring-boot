...
import br.com.wineone.data.vo.v1.UploadFileResponseVO;
import br.com.wineone.services.FileStorageService;
...
public class FileController {
	...
	public UploadFileResponseVO uploadFile(@RequestParam("file") MultipartFile file) {
		logger.info("uploading file in the disk");
	...
	public List<UploadFileResponseVO> uploadMultipleFile(@RequestParam("files") MultipartFile[] files) {
		logger.info("uploading files in the disk");
	...
	public ResponseEntity<Resource> downloadFile(@PathVariable String filename, HttpServletRequest request){
		...
		try {
			...
			logger.info("could not determine the type from the file");
		}
